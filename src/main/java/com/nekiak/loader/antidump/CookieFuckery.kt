...
interface CookieFuckery {
	...
	companion object: CookieFuckery {
		...
		override fun setPackageNameFilter() {
			val bytes = createDummyClass("com.nekiak.loader.antidump.MaliciousClassFilter")
			unsafe.defineClass("com.nekiak.loader.antidump.MaliciousClassFilter", bytes, 0, bytes.size, null, null)
			System.setProperty("sun.jvm.hotspot.tools.jcore.filter", "com.nekiak.loader.antidump.MaliciousClassFilter")
		}
